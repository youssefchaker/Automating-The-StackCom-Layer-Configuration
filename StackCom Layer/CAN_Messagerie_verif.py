    ...
    try:
        ...
        if CanIdValue is None and CanObjectType is None and CanIdType is None and CanHandleType is None and CanControllerRef is None and CanFilterMaskRef is None :
            ...
            if selected_frame.empty:
                ...
                result_data = {
                    'Frame Name': [frame_name],
                    'Passed?':["NOK" if CanIdValuetst ==False or CanIdTypetst==False or CanHandleTypetst==False or CanObjectTypetst==False or CanControllerReftst==False or CanFilterMaskReftst==False else "OK"],
